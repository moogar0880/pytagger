...
if __name__ == '__main__':
    ...
    # show = TVShow('House of Cards 2013')
    # print '[Show]'
    # pprint(show.__dict__)
    # season = show.search_season(2)
    # print '[Season]'
    ...
    #     pprint(ep.__dict__)
    #     break
    # layer_cake = Movie('layer cake')
    # pprint(layer_cake.__dict__)
    true_detective = TVShow('True Detective')
    season_1 = true_detective.search_season(1)
    for episode in season_1.episodes:
        pprint(episode.__dict__)
